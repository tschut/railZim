...
public class LevelDbAdapter {
    ...
    private static final String DATABASE_CREATE =
        ...
        + KEY_LEVELNUMBER   + " integer not null, "
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            PALManager.getLog().w(TAG, "Upgrading database from version " + oldVersion + " to "
    ...
    /** Insert a level
     *  Normally, this should only be done on the first run of the app,
     *  for all levels in the levels xml file */
    ...
    public Cursor fetchAllLevels() {
        return mDb.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_TITLE,
                KEY_LEVELNUMBER, KEY_HIGHSCORE}, null, null, null, null, null);
    }

    public int highScore (long aLevelID) {
        Cursor cursor = mDb.query(DATABASE_TABLE, new String[] {KEY_HIGHSCORE},
                KEY_LEVELNUMBER + "=" + aLevelID, null, null, null, null);
        cursor.moveToFirst();
    ...
    public boolean levelIsUnlocked (long aLevelID) {
        ...
        if (cursor.getCount() == 0) { // level doesn't exist, so pretend it's locked
            cursor.close();
            return false;
        }
        
        cursor.close();
        cursor = mDb.query(DATABASE_TABLE, new String[] {KEY_HIGHSCORE},
                KEY_LEVELNUMBER + "=" + (aLevelID - 1), null, null, null, null);
