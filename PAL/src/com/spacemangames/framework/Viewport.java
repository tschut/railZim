...
public class Viewport {
    ...
    public Viewport(boolean aFocusOnSpaceman, boolean aFocusX, boolean aFocusY,
    ...
    public void viewportFollowSpaceman () {
        ...
        synchronized (mViewport) {
            ...
            if (mPrevX == 0) mPrevX = lCurX;
            if (mPrevY == 0) mPrevY = lCurY;
            ...
            if (isFocusX()) lOffsetX = Math.round(lCurX - lViewCenterX);
            if (isFocusY()) lOffsetY = Math.round(lCurY - lViewCenterY);
            
            float lOffsetXDamped = lOffsetX * AUTO_FOCUS_DAMPING;
            float lOffsetYDamped = lOffsetY * AUTO_FOCUS_DAMPING;
            
            if (lOffsetX >= AUTO_FOCUS_MIN_PIXELS && lOffsetXDamped < AUTO_FOCUS_MIN_PIXELS) lOffsetXDamped = AUTO_FOCUS_MIN_PIXELS;
            if (lOffsetY >= AUTO_FOCUS_MIN_PIXELS && lOffsetYDamped < AUTO_FOCUS_MIN_PIXELS) lOffsetYDamped = AUTO_FOCUS_MIN_PIXELS;
